...
| 5 | Execution | — | L5 sealed workspace, L6 record plane 🟢 (rsys@3..5 live); class→writer invariant 🟢 (W-M1, 2026-09-26, L6 hash 1df0e285…); L5 witnesses decided (D-W-2/3) | evidence the record plane can replay | 🟡 | W-M2 |
...
| 12 | Ratchet (L11) ↔ Governance | Themis holds no runtime-method registry, by decision (D-R-1) | L11 criteria and regression sets 🟢; registration and reliance doors exist 🟢; decision-record provenance decided (D-R-2) | L11 → human → decision record → existing door; no automation path (D-R-4); commission validity independent of the doors (D-R-3) | 🟡 | I-M1: `policies/decisions/`, catalog and registry v2 with `decision_ref`, wall tests (`l11-governance-promotion/tasks.md`) |
