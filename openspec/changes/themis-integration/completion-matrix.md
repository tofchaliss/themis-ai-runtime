...
| 12 | Ratchet (L11) ↔ Governance | Governance has no notion of skill/workflow promotion | L11 criteria and regression sets 🟢 (`walk-report-score-delta@1`) | promotion boundary: who decides a skill revision is promotable, on which L11 evidence, and whether that is a Themis Governance act | 🔴 | grill OPEN 2026-09-26: `openspec/changes/l11-governance-promotion/` (Q-R-1..4); L11 already locks that promotion is a Governance act at the owning door |
